<template>
  <div>
    <el-autocomplete v-model="newValue" :fetch-suggestions="remoteMethod" v-bind="$attrs" :debounce="500" v-on="$listeners" @focus="inputFocus" @blur="inputBlur" @select="inputSelect">
