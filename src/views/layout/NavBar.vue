<template>
  <el-scrollbar :class="isOpen === true? 'left' : 'leftClose'" class="side-nav" wrap-class="scollbar">
    <!-- logo -->
    <div v-if="isOpen" class="logo">
      <img src="../../assets/images/logo/logo.png" alt="">
    </div>
    <div v-else class="mobile-logo">
      <img src="../../assets/images/logo/mobile-logo.png" alt="">
    </div>
    <!-- 菜单导航 -->
    <el-menu ref="navbar" :collapse="!isOpen" :default-active="defActive" :unique-opened="false" router class="el-menu-vertical-demo" mode="vertical" @select="clickLink">
