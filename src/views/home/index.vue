<template>
  <div v-once class="sys-page">
    ...
    <div class="page-content">
      ...
      <v-section title="什么是VueJS，为什么选用VueJS？">
        <div class="sys-article">
          ...
          <p>
            Angular学习曲线即为陡峭已经成为不争的事实。React的纯JS编程写模板则过于复杂，而且
          ...
          <p>
            不得不说我是十分讨厌那种非常重的框架的，我说的就是Angular。在我看来轻量简洁的框架是更适合前端开发的。因前端开发本身就在不断发展，而且前端页面变更频繁，重型框架很有可能根本不能适应业务的频繁变化和发展。
      ...
      <v-section title="框架涉及技术栈">
        <div class="sys-article">
          <p><strong>你必须了解以下技术栈，否则无法基于该框架编写程序</strong></p>
          <p>
            VueJS： <a target="_blank" href="http://cn.vuejs.org/">
              http://cn.vuejs.org/
            </a>&nbsp;&nbsp;&nbsp;——核心框架，必须掌握
          </p>
          <p>
            Vuex： <a target="_blank" href="https://vuex.vuejs.org/zh-cn/">
              https://vuex.vuejs.org/zh-cn/
            </a>&nbsp;&nbsp;&nbsp;——核心框架，必须掌握
          </p>
          <p>
            ElementUI： <a target="_blank" href="http://element.eleme.io/#/zh-CN">
              http://element.eleme.io/#/zh-CN
            </a>&nbsp;&nbsp;&nbsp;——核心框架，必须掌握
          </p>
          <p>
            Axios： <a target="_blank" href="https://github.com/mzabriskie/axios">
              https://github.com/mzabriskie/axios
            </a>&nbsp;&nbsp;&nbsp;——优秀的ajax库
          </p>
          <p>
            Vue-i18n： <a target="_blank" href="http://kazupon.github.io/vue-i18n/en">
        ...
        <div class="sys-article">
          ...
          <p>
            ES6： <a target="_blank" href="http://es6.ruanyifeng.com/">
              http://es6.ruanyifeng.com/
            </a>&nbsp;&nbsp;&nbsp;——ES第6版本，实现了众多新功能。本框架引入babel后不用担心兼容性问题。
          </p>
          <p>
            Lodash： <a target="_blank" href="https://lodash.com/docs">
              https://lodash.com/docs
            </a>&nbsp;&nbsp;&nbsp;——js工具库，增加众多对数组、对象、字符串的操作。比underscore要好
          </p>
          <p>
            echarts3： <a target="_blank" href="http://echarts.baidu.com/">
              http://echarts.baidu.com/
            </a>&nbsp;&nbsp;&nbsp;——图表插件
          </p>
          <p>
            高德地图： <a target="_blank" href="http://lbs.amap.com/api/javascript-api/summary/">
        ...
        <div class="sys-article">
          ...
          <p>
            Vue-router： <a target="_blank" href="https://router.vuejs.org/zh-cn/">
              https://router.vuejs.org/zh-cn/
            </a>&nbsp;&nbsp;&nbsp;——单页面应用必备。实现页面路由功能，通过监听url的变更而加载不同的页面
          </p>
          <p>
            Webpack中文： <a target="_blank" href="https://doc.webpack-china.org/">
              https://doc.webpack-china.org/
            </a>&nbsp;&nbsp;&nbsp;——最流行的打包工具。集合并、分割、打包等多功能于一身
          </p>
          <p>
            MockJS： <a target="_blank" href="http://mockjs.com">
              http://mockjs.com
            </a>&nbsp;&nbsp;&nbsp;——截获ajax，并返回模拟数据。在后台接口未完成时先进行开发
          </p>
        </div>
        <div class="sys-article">
          <p><strong>资料参考网站。</strong></p>
          <p>
            Can I Use： <a target="_blank" href="http://caniuse.com/">
              http://caniuse.com/
            </a>&nbsp;&nbsp;&nbsp;——Web技术兼容性查找
          </p>
          <p>
            MDN： <a target="_blank" href="https://developer.mozilla.org/zh-CN/">
              https://developer.mozilla.org/zh-CN/
            </a>&nbsp;&nbsp;&nbsp;——Mozilla基金会建立的Web技术网站
          </p>
          <p>
            NodeJS： <a target="_blank" href="http://nodejs.cn/api/">
              http://nodejs.cn/api/
            </a>&nbsp;&nbsp;&nbsp;——运行于服务器端的JS引擎。想实现某些类似Webpack或者Gulp功能时需要学习一下。做服务端必学
          </p>
        </div>
        <v-button :disabled="1===2" type="primary">按钮</v-button>
        <v-button :disabled="1===1" type="primary">按钮</v-button>
      </v-section>
    </div>
  </div>
</template>
