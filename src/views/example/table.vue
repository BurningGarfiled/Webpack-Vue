<template>
  <div class="sys-page">
    ...
    <!-- 工具条 -->
    <v-toolbar>
      <el-button v-hasPermission="'add'" type="primary">新增</el-button>
      <el-button v-hasPermission="'edit'" type="primary">修改</el-button>
    </v-toolbar>
    <!-- 表格体 -->
    <v-table-mixin pagination pagination-align="center">
      <el-table v-loading="tableData.loading" :data="tableData.body" :default-sort="{prop: 'date', order: 'descending'}" border style="width: 100%">
        <el-table-column type="index" label="序号" width="64" align="center"/>
        <el-table-column v-for="(item,index) in tableData.head" :prop="item.key" :label="item.name" :key="index" sortable/>
