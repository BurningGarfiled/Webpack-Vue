<template>
  <div class="sys-page">
    ...
    <el-table
      ...
      <el-table-column v-if="showReviewer" label="reviewer" width="110" align="center">
        <template slot-scope="scope">
          <span style="color:red;">{{ scope.row.reviewer }}</span>
        </template>
      </el-table-column>
      <el-table-column label="importance" width="90">
        <template slot-scope="scope">
      ...
      <el-table-column label="actions" align="center" width="300" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.status!='published'" type="success" @click="handleModifyStatus(scope.row,'published')">publish
          </el-button>
          <el-button v-if="scope.row.status!='draft'" @click="handleModifyStatus(scope.row,'draft')">draft
          </el-button>
          <el-button v-if="scope.row.status!='deleted'" type="danger" @click="handleModifyStatus(scope.row,'deleted')">delete
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from './api'
